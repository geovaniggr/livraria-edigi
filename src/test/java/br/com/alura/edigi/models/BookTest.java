...
public class BookTest {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            new Book("Java8", "Um livro sobre java", "1. O que é o java", "978-10-1234-12-1", new BigDecimal(-50), null,
                    null, null);
        } catch (IllegalArgumentException error) {
            System.out.println(error.getMessage() + "\n");
        }
        ...
        try {
            ...
            new Book("Java8", "Um livro sobre java", "1. O que é o java", "978-10-1234-12-1", null, null, null, null);
        } catch (IllegalArgumentException error) {
            System.out.println(error.getMessage() + "\n");
        }
        ...
        try {
            ...
            new Book("Java8", "Um livro sobre java", "1. O que é o java", "978-10-1234-12-1", new BigDecimal(0), 0,
                    null, null);
        } catch (IllegalArgumentException error) {
            System.out.println(error.getMessage() + "\n");
        }
        ...
        try {
            ...
            new Book("Java8", "Um livro sobre java", "1. O que é o java", "978-10-1234-12-1", new BigDecimal(0), 10,
                    null, null);
        } catch (IllegalArgumentException error) {
            System.out.println(error.getMessage() + "\n");
        }
        ...
        try {
            ...
            new Book("Java8", synopsis, "1. O que é o java", "978-10-1234-12-1", new BigDecimal(0), 10,
                    new Author("geovani", "geovani@alura.com.br"), null);
        } catch (IllegalArgumentException error) {
            System.out.println(error.getMessage() + "\n");
        }
        ...
        Book book = new Book("Java: 14", "Apenas uma Descrição", "1. o que é java?", "978-10-1234-12-1",
