...
public class BookTest {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            new Book("Java8", descriptonGreatherThan500, null, null, null, null, null, null);
        } catch (IllegalArgumentException error) {
            System.out.println(error.getMessage() + "\n");
        }
        ...
        try {
            ...
            new Book("Java8", descriptonGreatherThan500, "1. O que é o java", null, null, null, null, null);
        } catch (IllegalArgumentException error) {
            System.out.println(error.getMessage() + "\n");
        }
        ...
        try {
            ...
            new Book("Java8", descriptonGreatherThan500, "1. O que é o java", "3943213", null, null, null, null);
        } catch (IllegalArgumentException error) {
            System.out.println(error.getMessage() + "\n");
        }
        ...
        try {
            ...
            new Book("Java8", descriptonGreatherThan500, "1. O que é o java", "978-10-12314-12-1", new BigDecimal(-50), null,
                    null, null);
        } catch (IllegalArgumentException error) {
            System.out.println(error.getMessage() + "\n");
        }
        ...
        try {
            ...
            new Book("Java8", descriptonGreatherThan500, "1. O que é o java", "978-10-11234-12-1", null, null, null, null);
        } catch (IllegalArgumentException error) {
            System.out.println(error.getMessage() + "\n");
        }
        ...
        try {
            ...
            new Book("Java8", descriptonGreatherThan500, "1. O que é o java", "978-10-12234-12-1", new BigDecimal(50), null,
                    null, null);
        } catch (IllegalArgumentException error) {
            System.out.println(error.getMessage() + "\n");
        }
        ...
        try {
            System.out.println("Testando o número de páginas menor ou igual a 0 ");
            new Book("Java8", descriptonGreatherThan500, "1. O que é o java", "978-10-31234-12-1", new BigDecimal(0), 0,
                    null, null);
        } catch (IllegalArgumentException error) {
            System.out.println(error.getMessage() + "\n");
        }
        ...
        try {
            ...
            new Book("Java8", descriptonGreatherThan500, "1. O que é o java", "978-10-41234-12-1", new BigDecimal(0), 10,
                    null, null);
        } catch (IllegalArgumentException error) {
            System.out.println(error.getMessage() + "\n");
        }
        ...
        try {
            ...
            new Book("Java8", descriptonGreatherThan500, "1. O que é o java", "978-10-14234-12-1", new BigDecimal(0), 10,
        ...
        try {
            ...
            String synopsisLessThan500 = "Uma descrição pequena";
            new Book("Java8", synopsisLessThan500, "1. O que é o java", "978-10-14234-12-1", new BigDecimal(0), 10,
                    new Author("geovani", "geovani@alura.com.br"), null);
        } catch (IllegalArgumentException error) {
            System.out.println(error.getMessage() + "\n");
        }
        ...
        Book book = new Book("Java: 14", descriptonGreatherThan500, "1. o que é java?", "978-10-12434-12-1",
