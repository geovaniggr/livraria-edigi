...
public class BookTest {
    ...
    @Test
    @DisplayName("Criação de livro com algum campo nulo deve ser criado")
    ...
    @Test
    @DisplayName("Livro com ISBN com formato invalido não deve ser criado")
    ...
    @Test
    @DisplayName("Livro com preço negativo não deve ser criado")
    ...
    @Test
    @DisplayName("Livro com páginas menor igual a 0 não deve ser criado")
    ...
    @Test
    @DisplayName("Livro com descrição menor que 500 caracteres não deve ser criado")
